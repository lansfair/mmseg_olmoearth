custom_imports = dict(
    imports=["projects.olmoearth.olmoearth", "projects.copernicus.SVDT.copernicus"],
...
work_dir = "./work_dirs/olmoearth-base_upernet_4xb4-80k_SVDT-rgb-s2proxy-p4-256x256"
...
default_hooks = dict(
    ...
    visualization=dict(type="OlmoEarthVisualizationHook", interval=1),
)
